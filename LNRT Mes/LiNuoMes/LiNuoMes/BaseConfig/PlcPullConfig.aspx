<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlcPullConfig.aspx.cs" Inherits="LiNuoMes.BaseConfig.PlcPullConfig" %>
     ...
     <script>
        ...
        //加载表格
         function InitPage() {
             ...
             $("#FormTitle").html("物料拉动料号维护");
             $("[PLC_PANEL]").remove();

             $.ajax({
                 url: "GetSetBaseConfig.ashx",
                 data: {
                     "Action": "MES_PLC_PULL_CONFIG_LIST",
                     "GoodsCode": GoodsCode 
                 },
                 type: "post",
                 datatype: "json",
        ...
        function onSaveParameters(ListJason) {
            ...
            $.ajax({
                url: "GetSetBaseConfig.ashx",
                data: {
                    "Action"   : "MES_PLC_PULL_CONFIG_EDIT",
                    "GoodsCode": GoodsCode,
                    "ListJson" : ListJason
                },
                type: "post",
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <table id="panelheading" border="0" style="width:100%">
                                <tr>
                                    <th><i class="fa fa-bar-chart fa-lg" style="padding-right: 5px;"></i><strong style="font-size:20px;" id="FormTitle">物料拉动参数维护</strong></th>
                                </tr>
                            </table>
                        </div>
