<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadifyPlcExcel.aspx.cs" Inherits="FramWork.BaseConfig.UploadifyPlcExcel" %>
<!DOCTYPE html>
<html>
<head>
...
<script>
    ...
    function uploadify() {
        ...
        $("#uploadify").uploadify({
            ...
            buttonText: "选择文件",
            formData: {
                "Action": 'MES_PLC_PARAM_FILE_UPLOAD',
            ...
            onUploadSuccess: function (file, data) {
                ...
                if (result.result == "success") {
                    ...
                    g_InitPage("UPLOADREVIEW", result.targetFileName);
    ...
    function AcceptClick(inputobj, hiddenobj, initpage) {
        g_InputObj  = inputobj;
