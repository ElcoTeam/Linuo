<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EquMaintencePlanMan.aspx.cs" Inherits="LiNuoMes.Equipment.EquMaintencePlanMan" %>
    ...
    <div style="margin-left: 10px; margin-top: 20px; margin-right: 30px;">
            <table class="form" id="ruleinfo" style="margin-top:10px;">
                <tr>
                    ...
                    <td class="formValue">
                         <input id="PmSpecName" type="text" class="form-control"  isvalid="yes" checkexpession="NotNull" readonly />    
                    </td>

                    <th class="formTitle">工序名称<font face="宋体">*</font></th>
                    <td class="formValue">
                        <input id="ProcessName" type="text" class="form-control"  isvalid="yes" checkexpession="NotNull" readonly />
                 ...
                 <tr>
                    ...
                    <td class="formValue">
                       ...
                       <input id="DeviceName" type="text" class="form-control"  isvalid="yes" checkexpession="NotNull" readonly />
                    </td>
