<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaterialPullforwarehouse.aspx.cs" Inherits="LiNuoMes.LineMonitor.MaterialPullforwarehouse" %>
...
<head>
    ...
    <script>
        ...
        function GetGrid() {
            ...
            $gridTable.jqGrid({
                url: "hs/GetMaterialpullforwarehouse.ashx",
                datatype: "json",
                ...
                colModel: [
                    ...
                    {
                        label: '状态', name: 'ResponseState', index: 'ResponseState', width: 100, align: 'center',
                        formatter: function (cellvalue, options, rowObject) {
                            if (cellvalue == 1) {
                                return '<span  class=\"label label-success\">已响应</span>' + '<span onclick=\"btn_delete(\'' + rowObject[0] + '\')\" class=\"label label-danger\" style=\"cursor: pointer;margin-left:5px;\">删除</span>';
                            } else if (cellvalue == 0) {
                                return '<span onclick=\"btn_enabled(\'' + rowObject[0] + '\')\" class=\"label label-danger\" style=\"cursor: pointer;\">未响应</span>' + '<span onclick=\"btn_delete(\'' + rowObject[0] + '\')\" class=\"label label-danger\" style=\"cursor: pointer;margin-left:5px;\">删除</span>';
                            }
                        }
                    },
                ],
            ...
            //查询回车
            $('#materialcode').bind('keypress', function (event) {
                if (event.keyCode == "13") {
                    $('#btn_Search').trigger("click");
                }
            });
        ...
        function CreateSelect() {
            ...
            //var optionstring1 = "";
            $.ajax({
                url: "MaterialPullforwarehouse.aspx/GetProduceInfo",   
                type: "post",
                dataType: "json",
                data: "{deviceid:''}",
        ...
        function btn_enabled(keyValue) {
            ...
            if (keyValue) {
                   ...
                   window.setTimeout(function () {
                       $.ajax({
                           url: "MaterialPullforwarehouse.aspx/ConfirmPullInfo",
                           data: "{no:'" + keyValue + "'}",
                           type: "post",
                           dataType: "json",
                           contentType: "application/json;charset=utf-8",
            ...
            if (keyValue) {
                dialogConfirm("注：您确定要删除吗？该操作将无法恢复", function (r) {
                    if (r) {
                        ...
                        window.setTimeout(function () {
                            $.ajax({
                                url: "MaterialPullforwarehouse.aspx/DeletePullInfo",
                                data: "{no:'" + keyValue + "'}",
                                type: "post",
                                dataType: "json",
                                contentType: "application/json;charset=utf-8",
            ...
            <div style="float: left; width: 100%;">
                <div style="height:20%; border: 1px solid #e6e6e6; background-color: #fff;">
                    <div class="panel panel-default">
                        <div class="panel-heading"><i class="fa fa-bar-chart fa-lg" style="padding-right: 5px;"></i><strong style="font-size:30px;">物料拉动响应</strong></div>
