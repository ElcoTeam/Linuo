<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlcChanOperate.aspx.cs" Inherits="LiNuoMes.Mfg.PlcChanOperate" %>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.result == "success") {
                        ...
                        dialogMsg("变更指令发送成功, 此批次共发送参数: " + ParamesCount + " 条.", 1);
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <table id="panelheading" border="0" style="width:100%">
                                <tr>
                                    <th><i class="fa fa-bar-chart fa-lg" style="padding-right: 5px;"></i><strong style="font-size:20px;" id="FormTitle">发送变更产品请求</strong></th>
                                </tr>
                            </table>
                        </div>
                            ...
                            <table border="0" style="width:100%">
                                <tr>
                                    ...
                                    <td style="text-align:right;margin-right:20px">                                          
                                        <a id="btn_SD" class="btn btn-primary" onclick="onSD(event)"><i class="fa fa-bars" ></i>发送</a>  
