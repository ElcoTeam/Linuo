         ...
         $(function () {
             ...
             $gridTable.jqGrid({
                 ...
                 colModel: [
                     ...
                     { label: '物料编码', name: 'ItemNumber', index: 'ItemNumber', width: 220, align: 'center', sortable: false },
                     { label: '物料描述', name: 'ItemDsca', index: 'ItemDsca', width: 380, align: 'left', sortable: false },
