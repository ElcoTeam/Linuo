...
{
    public partial class FirstLevelInspectionReport : System.Web.UI.Page
    {
        ...
        public static string GetProcessInfo()
        {
            ...
            using (var conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ELCO_ConnectionString"].ToString()))
            {
                ...
                conn.Open();
                cmd.Connection = conn;
                string str1 = "select distinct a.ProcessCode,b.ProcessName from Equ_DeviceInfoList a  left join Mes_Process_List b on a.ProcessCode=b.ProcessCode";
