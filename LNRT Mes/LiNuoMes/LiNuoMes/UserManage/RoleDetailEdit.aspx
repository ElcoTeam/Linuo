<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleDetailEdit.aspx.cs" Inherits="LiNuoMes.UserManage.RoleDetailEdit" %>
...
<body>
     <script>
         ...
         function AcceptClick(grid) {
             ...
             $.ajax({
                 url: "RoleDetailEdit.aspx/SaveRoleInfo",
    ...
    <div class="ui-layout" id="layout" style="height: 100%; width: 100%;">
      <div class="ui-layout-west">
        <div class="west-Panel" style="margin: 0px; border-top: none; border-left: none; border-bottom: none;">
            <div style="color:#9f9f9f;padding-top:5px; padding-bottom:5px;padding-left:8px;"><i style="padding-right:5px;" class="fa fa-info-circle"></i><span>编辑角色基本信息</span></div>
            <table class="form" id="ruleinfo" style="margin-top:10px;">
                <tr>
                    <th class="formTitle">角色名称<font face="宋体">*</font></th>
                    <td class="formValue">
                         <input type="text" class="form-control" id="RoleName" isvalid="yes" checkexpession="NotNull">
                    </td>
                </tr>
               <tr>
                ...
                <tr>
                    <td class="formValue" colspan="2">
                        <textarea id="Description"  class="form-control" style="height: 210px; margin-left:5px;"></textarea>
                    </td>
                </tr>
    ...
    <div class="ui-layout-center">
           ...
           <div class="center-Panel" style="margin: 0px; border-right: none; border-left: none; border-bottom: none; background-color: #fff; overflow: auto; padding-bottom: 10px;">
               <div style="color:#9f9f9f;padding-top:5px; padding-bottom:5px;padding-left:8px;"><i style="padding-right:5px;" class="fa fa-info-circle"></i><span>编辑角色权限信息</span></div>
