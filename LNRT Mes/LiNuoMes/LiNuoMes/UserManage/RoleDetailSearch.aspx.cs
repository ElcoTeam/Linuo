...
{
    public partial class RoleDetailSearch : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static List<RoleInfo> GetRoleInfo(string RoleID)
        {
            ...
            using (var conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ELCO_ConnectionString"].ToString()))
            {
                ...
                str1 = "select a.RoleName,a.Description,b.MenuNo from UserM_RoleInfo a left join UserM_RoleLimit b on a.RoleID=b.RoleID where a.RoleID='" + RoleID.Trim() + "'";
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = str1;
                SqlDataAdapter Datapter = new SqlDataAdapter(cmd);
                Datapter.Fill(tb);
                ReturnValue = DataTableJson(tb);
                list = JsonToList<RoleInfo>(ReturnValue);
                return list;
            }
