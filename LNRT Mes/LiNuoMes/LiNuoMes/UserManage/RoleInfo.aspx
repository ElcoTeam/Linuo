<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleInfo.aspx.cs" Inherits="LiNuoMes.UserManage.RoleInfo" %>
...
<title>力诺瑞特平板集热器</title>
    ...
    <script src="../Content/scripts/utils/learun-form.js"></script>
     <script>
        $(function () {
            ...
            $("#btn_Add").click(function (event) {
                ...
                dialogOpen({
                      id: "Form",
                      title: '新增角色信息',
                      url: '../UserManage/RoleDetailInfo.aspx',
                      width: "600px",
                      height: "600px",
                      async: true,
        ...
        function GetGrid() {
            ...
            $gridTable.jqGrid({
                ...
                colModel: [
                    ...
                    { label: '角色说明', name: 'Description', index: 'Description', width: 400, align: 'left', sortable: false },
                    {
            ...
            $("#btn_Search").click(function () {
                ...
                $gridTable.jqGrid('setGridParam', {
                    postData: { Rolename: rolename }, page: 1
                }).trigger('reloadGrid');
            });
            //查询回车
        ...
        //查看角色信息
        function btn_search(roleid) {
            if (roleid == undefined) {
                roleid = $("#gridTable").jqGridRowValue("RoleID");
            }
            dialogOpen({
                id: "Form",
                title: '查看角色信息',
                url: '../UserManage/RoleDetailSearch.aspx?roleid='+roleid+'',
                width: "600px",
                height: "600px",
                btn: null
            });
        ...
        function btn_edit(roleid) {
            ...
            dialogOpen({
                id: "Form",
                title: '编辑角色信息',
                url: '../UserManage/RoleDetailEdit.aspx?roleid=' + roleid + '',
                width: "600px",
                height: "600px",
                callBack: function (iframeId) {
                    top.frames[iframeId].AcceptClick($("#gridTable"));
        ...
        function btn_delete(roleid) {
            ...
            dialogConfirm("注：您确定要删除吗？该操作将无法恢复", function (r) {
                if (r) {
                    ...
                    window.setTimeout(function () {
                        $.ajax({
                            url: "RoleInfo.aspx/DeleteRoleInfo",
                            data: "{RoleID:'" + roleid + "'}",
                            type: "post",
                            dataType: "json",
            ...
            <div style="float: left; width: 100%;">
                <div style="height:20%; border: 1px solid #e6e6e6; background-color: #fff;">
                    <div class="panel panel-default">
                        <div class="panel-heading"><i class="fa fa-bar-chart fa-lg" style="padding-right: 5px;"></i><strong style="font-size:20px;">角色信息管理</strong></div>
                            ...
                            <table id="form1" class="form">
                                <tr>
                                    ...
                                    <td class="formValue">
                                          ...
                                          <a id="btn_Add" class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp;新建</a>                          
                                     </td>
                                </tr>
                            </table>
                        </div>
