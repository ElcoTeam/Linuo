...
{
    public partial class UserDetailEdit : System.Web.UI.Page
    {
        ...
        public static List<UserInfo> GetUserInfo(string UserID)
        {
            ...
            using (var conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ELCO_ConnectionString"].ToString()))
            {
                ...
                str1 = "select a.UserID,a.UserName,a.RoleID,a.Description,c.ProcessCode from UserM_UserInfo a left join UserM_RoleInfo b on a.RoleID=b.RoleID left join Mes_Process_List c on a.ProcessCode=c.ProcessCode where a.ID='" + UserID.Trim() + "' ";
        ...
        [WebMethod]
        public static string SaveUserInfo(string UserID, string UserName, string RoleID, string Description, string ProcessCode)
        {
            ...
            using (var conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ELCO_ConnectionString"].ToString()))
            {
                ...
                try
                {
                    ...
                    sqlPara[2] = new SqlParameter("@RoleID", RoleID == null ? "" : RoleID);
                    sqlPara[2].Direction = System.Data.ParameterDirection.Input;
                   
                    sqlPara[3] = new SqlParameter("@Description", Description);
                    sqlPara[3].Direction = System.Data.ParameterDirection.Input;

                    sqlPara[4] = new SqlParameter("@ProcessCode", ProcessCode);
                    ...
                    cmd.CommandText = "[usp_UserM_EditUserInfo]";
                    cmd.ExecuteNonQuery();
                    transaction.Commit();
                    return "success";
                }
