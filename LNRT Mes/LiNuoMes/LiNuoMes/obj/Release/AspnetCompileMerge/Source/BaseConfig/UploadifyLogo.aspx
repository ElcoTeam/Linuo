<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadifyLogo.aspx.cs" Inherits="FramWork.BaseConfig.UploadifyLogo" %>
<!DOCTYPE html>
<html>
<head>
...
<script>
    ...
    function uploadify() {
        $("#uploadify").uploadify({
            method: 'post',
            uploader: '../BaseConfig/GetSetBaseConfig.ashx',
            swf: '../Content/scripts/plugins/uploadify/uploadify.swf',
            buttonText: "选择文件",
            formData: { Action: 'MFG_WO_LIST_FILE_UPLOAD' },
            height: 30,
            width: 90,
            auto: false,
            multi:false,
    ...
    function goDownload() {
        ...
        //     <span id="comLN" onclick="goDownload();">插件下载</span>
   }
