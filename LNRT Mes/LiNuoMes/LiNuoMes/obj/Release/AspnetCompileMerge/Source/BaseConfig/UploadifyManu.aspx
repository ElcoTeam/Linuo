<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadifyManu.aspx.cs" Inherits="FramWork.BaseConfig.UploadifyManu" %>
<!DOCTYPE html>
<html>
<head>
...
<script>
    ...
    function uploadify() {
        $("#uploadify").uploadify({
            ...
            buttonText: "选择文件",
            formData: { Action: 'MES_PROC_CONFIG_FILE_UPLOAD' },
            height: 30,
            width: 90,
            auto: false,
            multi:false,
