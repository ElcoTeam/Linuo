    ...
    f.pt.vessel = function (a, b) {
        ...
        function () {
            ...
            if (e.type[f.type] == "iframe") {
                Content_IsClose = '<div style="float: left;padding-top:5px;padding-left:15px;-moz-user-select: none;-webkit-user-select: none;-ms-user-select: none;-khtml-user-select: none;user-select: none;">';
            }
    ...
    f.pt.creat = function () {
        ...
        switch ("string" == typeof b.area && (b.area = "auto" === b.area ? ["", ""] : [b.area, ""]), b.type) {
            ...
            case 2:
                ...
                b.content = ajaxloader + '<iframe scrolling="no" allowtransparency="true" id="' + b.id + '" name="' + b.id + '" onload="Loading(false);" frameborder="0" src="' + b.content[0] + '"></iframe>';
                break;
            case 3:
                b.title = !1,
                b.closeBtn = !1,
