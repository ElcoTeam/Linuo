<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadifyManu.aspx.cs" Inherits="LiNuoMes.Equipment.UploadifyManu" %>
...
<div style="margin: 10px">
    ...
    <div class="border" style="height: 35px; border-radius: 5px;">
        <div class="drag-tip" style="text-align: center; ">
            <h1 style="color: #666; font-size: 20px; font-family:'Microsoft YaHei';">请点击"选择文件"按钮, 选择要上传的文件(支持PDF、WORD格式)</h1>
       </div>
    </div>
</div>
    </form>
