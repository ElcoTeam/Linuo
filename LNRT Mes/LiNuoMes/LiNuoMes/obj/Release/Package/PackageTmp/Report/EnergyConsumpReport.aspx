<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EnergyConsumpReport.aspx.cs" Inherits="LiNuoMes.Report.EnergyConsumpReport" %>
<!DOCTYPE html>
...
<title>力诺瑞特平板集热器</title>
    ...
    <script>
        ...
        function InitPage() {
            ...
            $gridTable.jqGrid({
                ...
                colModel: [
                    ...
                    {
                        label: '能耗', name: 'Consump', index: 'Consump', width: panelwidth * 0.2, align: 'center'
                    },
                    {
                        label: '单台消耗', name: 'PerConsump', index: 'PerConsump', width: panelwidth * 0.2, align: 'center'
                    },
        ...
        function btn_export(event) {
            ...
            ExportJQGridDataToExcel('#gridTable','能耗统计报表');
        }
